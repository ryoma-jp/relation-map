...
class TestEntityModel:
    ...
    def test_entity_model_valid(self, db_session):
    ...
    def test_entity_required_fields(self, db_session):
    ...
    def test_entity_optional_description(self, db_session):
        """Test entity with optional description."""
        entity = models.Entity(name="Jane", type="person")
        db_session.add(entity)
        db_session.commit()
    ...
    def test_entity_relationships(self, db_session):
        ...
        # Create entities
        source = models.Entity(name="Alice", type="person")
        target = models.Entity(name="Bob", type="person")
    ...
    def test_entity_cascade_delete(self, db_session):
        """Test that deleting an entity cascades to relations."""
        # Create entities and relation
        source = models.Entity(name="X", type="person")
        target = models.Entity(name="Y", type="person")
        db_session.add(source)
        db_session.add(target)
        db_session.flush()
...
class TestRelationModel:
    ...
    def test_relation_model_valid(self, db_session, sample_entities):
    ...
    def test_relation_required_fields(self, db_session):
    ...
    def test_relation_foreign_key_constraint(self, db_session):
...
class TestEntityTypeModel:
    ...
    def test_entity_type_valid(self, db_session):
    ...
    def test_entity_type_unique_constraint(self, db_session):
...
class TestRelationTypeModel:
    ...
    def test_relation_type_valid(self, db_session):
    ...
    def test_relation_type_unique_constraint(self, db_session):
        """Test relation type name uniqueness."""
        type1 = models.RelationType(name="Friend")
        db_session.add(type1)
        db_session.commit()
        
        # Try to create duplicate
        type2 = models.RelationType(name="Friend")
        db_session.add(type2)
        with pytest.raises(IntegrityError):
            db_session.commit()
...
class TestDatabaseOperations:
    ...
    def test_session_commit_rollback(self, db_session):
        ...
        # Add entity
        entity = models.Entity(name="Test1", type="person")
        db_session.add(entity)
        db_session.commit()
        ...
        # Add and rollback
        entity2 = models.Entity(name="Test2", type="person")
    ...
    def test_bulk_operations(self, db_session):
        ...
        # Bulk insert
        entities = [
            models.Entity(name=f"Bulk{i}", type="person")
            for i in range(10)
        ]
    ...
    def test_query_filters(self, db_session):
        """Test various query filters."""
        # Create diverse entities
        entities = [
            models.Entity(name="Alice", type="person"),
            models.Entity(name="Bob", type="person"),
            models.Entity(name="CompanyA", type="organization"),
        ]
        db_session.add_all(entities)
        db_session.commit()
